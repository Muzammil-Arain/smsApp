...
import React, {useEffect, useState} from 'react';
import { Button,DeviceEventEmitter,EmitterSubscription, Platform } from 'react-native';
...
export default function App() {
  React.useEffect(() => {
    ...
    async function innerAsync() {
      ...
      try {
        const selectedPhone = await RnSmsRetriever.getAppHash();
